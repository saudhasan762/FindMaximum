...
public class FindMaximumTest {
    ...
    @Test
    public void checkMaximumInteger_FirstPosition(){
    ...
    @Test
    public void checkMaximumInteger_SecondPosition(){
        FindMaximum findMax = new FindMaximum();
    ...
    @Test
    public void checkMaximumInteger_ThirdPosition(){
        FindMaximum findMax = new FindMaximum();
    ...
    @Test
    public void checkMaximumFloats_FirstPosition(){
        FindMaximum findMax = new FindMaximum();
    ...
    @Test
    public void checkMaximumFloats_SecondPosition(){
        FindMaximum findMax = new FindMaximum();
    ...
    @Test
    public void checkMaximumFloats_ThirdPosition(){
        FindMaximum findMax = new FindMaximum();
